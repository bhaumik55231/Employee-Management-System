...
<br/><br/>
<form action="<%=request.getContextPath()%>/directoryController?flag=updateDirectoryPermissionOfSuperManager" method="post">
<table align="center">
<c:forEach items="${requestScope.directoryList }" var="x">
